...
const Footer = () => {
  ...
  return (
    <>
      ...
      <footer className="bg-[#18191b] text-white relative overflow-hidden py-16">
     ...
     <img src="./src/assets/element1.png" alt="" />
        </div>

        {/* Decorative Spiral Right */}
          <img className='absolute right-28 top-1/2 rotating-element transition-all duration-1000 opacity-100 scale-100' src="./src/assets/element2.png" alt="" />
        ...
        <div className="max-w-7xl mx-auto px-6 py-16 relative z-10">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
            ...
            <div data-aos="fade-up" className="space-y-6">
              ...
              <div className="flex gap-2">
                <div className="flex-1 bg-white  text-gray-400 rounded-full px-4 py-3 flex items-center gap-2">
            ...
            <div data-aos="fade-up" data-aos-delay="200" className="space-y-4">
              ...
              <ul className="space-y-3">
                <li>
                  <a href="#" className=" hover:text-[#9CFE4F] transition-colors text-sm">
                    About us
                  </a>
                </li>
                <li>
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href="mailto:info@agenko.com" className=" text-sm hover:text-[#9CFE4F] transition-colors">
                      info@agenko.com
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href="tel:+15557659854" className=" text-sm hover:text-[#9CFE4F] transition-colors">
                      +555-7659-9854
                    </a>
                  </div>
                </div>
          ...
          <div className="border-t border-[#313131] mt-12 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
            <p className=" text-sm">
              © 2025 <span className="text-[#9CFE4F] font-semibold">Agenko</span> - All Rights Reserved.
            </p>
            
            <div className="flex gap-8">
              <a href="#" className=" hover:text-[#9CFE4F] text-sm transition-colors">
                Terms & Condition
              </a>
              <a href="#" className=" hover:text-[#9CFE4F] text-sm transition-colors">
                Privacy Policy
