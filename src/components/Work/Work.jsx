  ...
  const projects = [
    {
      ...
      description: "We develop secure, user-friendly banking apps, streamlining financial services",
    ...
    },
    {
      ...
      description: "Crafting a fresh, vibrant brand identity for Knead That Dough.",
      categories: ["Website", "Landing Page", "UI/UX"],
    ...
    },
    {
      ...
      description: "Building innovative software solutions to drive your business forward.",
      categories: ["Website", "Landing Page", "UI/UX"],
        ...
        <div className="container mx-auto px-4 max-w-7xl">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
            <div className="lg:col-span-7 space-y-16">
              {/* Project 1 */}
              <div className="project-item group" data-aos="fade-up" data-aos-delay="100">
              ...
              {/* Project 3 */}
              <div className="project-item group" data-aos="fade-up" data-aos-delay="300">
                <div className="relative overflow-hidden rounded-2xl mb-6">
            ...
            <div className="lg:col-span-5 space-y-16">
              {/* Project 2 */}
              <div className="project-item group" data-aos="fade-up" data-aos-delay="200">
                <div className="relative overflow-hidden rounded-2xl mb-6">
              ...
              {/* Project 4 */}
              <div className="project-item group" data-aos="fade-up" data-aos-delay="400">
                <div className="relative overflow-hidden rounded-2xl mb-6">
